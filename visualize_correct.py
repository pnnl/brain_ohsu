...
vol = read_tiff_stack('data/testing/testing-original/labels/cube2_188.tiff')
write_folder_stack(vol,  f"slices_truth_volumes")

input_folder = "data/testing/testing-original/labels"

vol = read_tiff_stack('data/testing/testing-original/labels/cube2_labels.tiff')
write_folder_stack(vol, f"slices_truth_labels")
